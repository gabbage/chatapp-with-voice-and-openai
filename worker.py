...
base_url_tts = "https://sn-watson-tts.labs.skills.network"

base_url_stt = "https://sn-watson-stt.labs.skills.network"

def speech_to_text(audio_binary):
    api_url = base_url_stt+'/speech-to-text/api/v1/recognize'
...
def text_to_speech(text, voice=""):
    ...
    api_url = base_url_tts + '/text-to-speech/api/v1/synthesize?output=output_text.wav'
